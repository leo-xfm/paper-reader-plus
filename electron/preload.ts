...
contextBridge.exposeInMainWorld("paperReaderPlus", {
  ...
  listGroups: () => ipcRenderer.invoke("library:list-groups"),
  createGroup: (name: string) => ipcRenderer.invoke("library:create-group", name),
  renameGroup: (groupId: string, name: string) => ipcRenderer.invoke("library:rename-group", groupId, name),
  deleteGroup: (groupId: string, mode: "group-only" | "history-records") => ipcRenderer.invoke("library:delete-group", groupId, mode),
  moveDocumentsToGroup: (documentIds: string[], groupId: string | null) => ipcRenderer.invoke("library:move-documents-to-group", documentIds, groupId),
  clearDocumentHistory: (mode: "readerp" | "readerm" | "all") => ipcRenderer.invoke("library:clear-history", mode),
  ...
  markDocumentOpened: (documentId: string) => ipcRenderer.invoke("documents:mark-opened", documentId),
  setDocumentPinned: (documentId: string, pinned: boolean) => ipcRenderer.invoke("documents:set-pinned", documentId, pinned),
  ...
  showDocumentContextMenu: (documentId: string, documentIds?: string[]) => ipcRenderer.invoke("documents:show-context-menu", documentId, documentIds),
